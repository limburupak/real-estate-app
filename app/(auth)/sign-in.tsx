...
export default function SignInScreen() {
  ...
  const onResetSignIn = async () => {
    try {
      setIsResetting(true);
      setError("");
      await signIn.reset();
    } catch (err) {
      setError(err instanceof Error ? err.message : "Failed to reset sign-in");
      console.error("Error resetting sign-in:", err);
    } finally {
  ...
  const onSignInPress = async () => {
    ...
    if (signIn.status === "complete") {
      ...
      if (phoneCodeFactor) {
        ...
        setError("Phone MFA is not supported for this account");
      }
